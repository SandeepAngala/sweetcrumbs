<x-guest-layout>
    ...
    <div class="mb-6 text-center md:text-left">
        <h2 class="font-display text-2xl font-black text-coffee-800 dark:text-white leading-tight">Confirm Password</h2>
    ...
    <form method="POST" action="{{ route('password.confirm') }}" id="confirmPasswordForm" class="space-y-6">
        ...
        <!-- Submit Button -->
        <button type="submit" 
                onclick="handleConfirmPasswordSubmit(this, event)"
            ...
            <span id="btnText">Confirm Password</span>
    ...
    <script>
        ...
        function handleConfirmPasswordSubmit(btn, e) {
            const form = document.getElementById('confirmPasswordForm');
            if(form.checkValidity()) {
                document.getElementById('btnText').textContent = 'Confirming...';
