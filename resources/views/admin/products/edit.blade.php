...
@php
    ...
    foreach ($images ?? [] as $img) {
        if (\Illuminate\Support\Str::startsWith($img, ['http://', 'https://']) && !\Illuminate\Support\Str::contains($img, 'unsplash.com')) {
            $externalUrl = $img;
            break;
        }
    }
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-xs text-coffee-600 dark:text-gray-400 mt-0.5">Select a new product photo or enter an image URL in the fields above, then click below to let AI automatically generate updated details.</p>
                            </div>
                        </div>
