...
<div class="space-y-8">
    ...
    <div class="flex items-center gap-2 border-b border-coffee-100 dark:border-gray-800 pb-5">
        ...
        <div>
            <h1 class="font-display text-3xl font-bold text-coffee-950 dark:text-white">Create Coupon</h1>
            <p class="text-xs text-coffee-500 dark:text-gray-400 mt-1">Configure a new discount code for promotional campaigns</p>
        </div>
    </div>

    <!-- Coupon Form -->
    <form action="{{ route('admin.coupons.store') }}" method="POST" class="space-y-6 max-w-2xl">
        @csrf
        ...
        <div class="bg-white dark:bg-gray-900 rounded-3xl border border-coffee-100 dark:border-gray-800 p-8 shadow-sm space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code') }}" required placeholder="e.g. WELCOME50" class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-800 text-coffee-900 dark:text-white font-mono font-bold focus:outline-none focus:ring-2 focus:ring-bakery-gold-400">
                    @error('code')
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="value" id="value" value="{{ old('value') }}" required placeholder="e.g. 10 or 150.00" class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-800 text-coffee-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-bakery-gold-400 font-medium">
                    @error('value')
                        <p class="text-xs text-rose-500 mt-1.5 font-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount') }}" placeholder="e.g. 500" class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-800 text-coffee-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-bakery-gold-400 font-medium">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="max_discount" id="max_discount" value="{{ old('max_discount') }}" placeholder="e.g. 200" class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-800 text-coffee-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-bakery-gold-400 font-medium">
                    @error('max_discount')
                        <p class="text-xs text-rose-500 mt-1.5 font-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit') }}" placeholder="e.g. 100" class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-800 text-coffee-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-bakery-gold-400 font-medium">
                    @error('usage_limit')
                        <p class="text-xs text-rose-500 mt-1.5 font-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="expires_at" id="expires_at" value="{{ old('expires_at') }}" required class="w-full px-4 py-3 rounded-xl bg-coffee-50/50 dark:bg-gray-950/50 border border-coffee-100 dark:border-gray-850 text-coffee-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-bakery-gold-400 text-sm font-semibold">
                    @error('expires_at')
                        <p class="text-xs text-rose-500 mt-1.5 font-bold">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center pt-2">
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <span class="ml-3 text-xs font-bold uppercase tracking-wider text-coffee-600 dark:text-gray-400">Coupon Active Immediately</span>
                </label>
            </div>
